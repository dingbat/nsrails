...
NSRails is a light-weight Objective-C framework to make interfacing with a Rails server incredibly easy.


h3. What can NSRails do?

NSRails builds ActiveResource support straight into your Objective-C models, meaning CRUD operations and others can be called seamlessly via Objective-C methods. For example, all it takes to create a new user from Objective-C is @[user remoteCreate];@ (after setting, say, a @username@ property) and it'll go straight to your Rails server.

It's very simple to use but also flexible, powerful, and customizable. Some features include:
* Keep models and properties of your choice "in-sync":https://github.com/dingbat/nsrails/wiki/NSRailsify with Rails
* Support for "nesting":https://github.com/dingbat/nsrails/wiki/Nesting models
