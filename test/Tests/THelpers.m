...
@synthesize string, date, anything, primitiveInt, primitiveBOOL, primitiveFloat, curve, rect;
...
{
	NSRAssertEqualArraysNoOrder([TheManInsideMe allProperties].allKeys, @"string", @"date", @"array", @"anything", @"primitiveInt", @"primitiveBOOL", @"primitiveFloat", @"curve", @"rect");
	...
	GHAssertNotNil([TheManInsideMe typeForProperty:@"curve"],@"");
	...
	[TheManInsideMe typeForProperty:@"curve" isPrimitive:&primitive];
	GHAssertTrue(primitive, @"curve is primitive");
