...
- (void) test_nested_contexts
{
	...
	GHAssertEqualStrings(@"class_with_no_rails_sync", [ClassWithNoRailsSync masterModelName], @"auto-underscoring");
	...
	[c useIn:
	 ^{
		 ...
		 GHAssertEqualStrings(@"ClassWithNoRailsSync", [ClassWithNoRailsSync masterModelName], @"No auto-underscoring");
	 }];
...
- (void) test_format_app_url
{
	[[NSRConfig defaultConfig] setAppURL:@"localhost:3000/"];
	GHAssertEqualStrings([NSRConfig defaultConfig].appURL, @"http://localhost:3000", @"No http://, trailing /");

	[[NSRConfig defaultConfig] setAppURL:@"localhost:3000"];
	GHAssertEqualStrings([NSRConfig defaultConfig].appURL, @"http://localhost:3000", @"No http://");
	
	[[NSRConfig defaultConfig] setAppURL:@"http://localhost:3000/"];
	GHAssertEqualStrings([NSRConfig defaultConfig].appURL, @"http://localhost:3000", @"Trailing /");

	[[NSRConfig defaultConfig] setAppURL:@"http://localhost:3000"];
	GHAssertEqualStrings([NSRConfig defaultConfig].appURL, @"http://localhost:3000", @"Perfect, no change");

	[[NSRConfig defaultConfig] setAppURL:@"https://localhost:3000"];
	GHAssertEqualStrings([NSRConfig defaultConfig].appURL, @"https://localhost:3000", @"Retains https");
}
